...
class TestAscendingAuctionWithSingleRecipe(ascending_auction_test.TestAscendingAuction):
    ...
    def _check_market(self, market: Market, ps_recipe: List[int], expected_num_of_deals: int,
...
class TestAscendingAuctionWithTwoRecpies(unittest.TestCase):
    ...
    def _check_market(self, market: Market, ps_recipe_struct: List[Any], expected_num_of_deals: int,
                      expected_prices: List[float]):
        trade = ascending_auction_recipetree_protocol.budget_balanced_ascending_auction(market, ps_recipe_struct)
        self.assertEqual(trade.num_of_deals(), expected_num_of_deals)
    ...
    def test_market_1100_1011(self):
        ...
        # show_log()
        check_1100_1011(buyers=[19, 17, 15, 13, 11, 9], sellers=[], producers=[-6, -5, -4, -3, -2, -1],
                        movers=[-6, -5, -4, -3, -2, -1],
    ...
    def test_market_11100_10011(self):
        ...
        def check_11100_10011(buyers: List[float], sellers1: List[float], sellers2: List[float],
                              producers1: List[float], producers2: List[float],
                              expected_num_of_deals: int, expected_prices: List[float]):
            market = Market([
                AgentCategory("buyer", buyers),
        ...
        check_11100_10011(buyers=[400, 300, 200, 100], sellers1=[-1, -2], sellers2=[-3, -4], producers1=[-5, -6],
                          producers2=[-7, -8],
