...
class TradeWithSinglePrice(Trade):
    ...
    self.ps_recipe:  a vector of k integers - one per category - the number of traders from this category in each PS.
        ...
        for category_index in range(self.num_categories):
            ...
            if count_in_recipe > 0:
                ...
                if existing_agents == required_agents:
                    ...
                    s += "{}: random {} out of {} agents trade and pay {}\n".format(category, required_agents,
                                                                                    existing_agents, price)
        return s.rstrip()
